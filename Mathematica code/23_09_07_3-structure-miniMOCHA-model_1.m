...
(*defines MOCHA model and optimal allocation formula*)
...
(*optimal allocation for 2x2 MOCHA*)
...
(*the applide 3x3 MOCH model, define allocation \[Alpha]'s, and model matrix*)
...
(*optimal allocation for 3x3 MOCHA, assuming zero waste solution is optimal (i.e. it's not an "edge case")*)
...
(*optimal allocation for 3x3 MOCHA, accounting for edge cases*)
